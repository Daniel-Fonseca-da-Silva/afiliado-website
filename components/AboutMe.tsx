import { aboutme, metodocvl } from "@/public/assets";
    ...
    <section className="w-full mx-auto py-10 mdl:py-24 flex flex-col items-center gap-4 lgl:gap-8 mdl:px-10 xl:px-4 mt-10">
      <div className="w-10/12 my-10">
        <div className="flex flex-col md:flex-row justify-center">
          ...
          <div className="mx-auto md:w-2/4">
            <h2 className="font-titleFont xs:text-base xs:text-center sm:text-base xs:pt-40 md:pt-0 md:text-lg lg:text-5xl font-semibold uppercase">
              muito prazer, eu sou{" "}
